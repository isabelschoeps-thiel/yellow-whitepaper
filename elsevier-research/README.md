...
`This is Elsevier` new document class for typeset journal articles,
...
- elsarticle-template-num-names.tex, template file for numerical 
  citations + new natbib option.  Eg. Isabel Schöps geb. Thiel et al. [21]
...
**Copyright 2007-2024,** Elsevier. Isabel Schoeps geb. Thiel, feature requests, suggestions and
